...
class Login : AppCompatActivity() {
    ...
    private fun setupUI() {
        ...
        inputField.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                ...
                sendOtpBtn.isEnabled = isValid
                sendOtpBtn.backgroundTintList = ColorStateList.valueOf(
        ...
        inputField.setOnFocusChangeListener { _, hasFocus ->
            if (hasFocus) {
                scrollToView(mainScrollView, inputField)
            }
        }

        sendOtpBtn.setOnClickListener {
            val phoneOrUHID = inputField.text.toString().trim()
    ...
    private fun setupObservers() {
        ...
        viewModel.loading.observe(this) { isLoading ->
            sendOtpBtn.isEnabled = !isLoading
    ...
    private fun showVitalDialog(title: String) {
        ...
        val dialogView =
            LayoutInflater.from(this).inflate(R.layout.login_multiple_dialog, null)
