package com.critetiontech.ctvitalio.Database;
...
public class OmronDBProvider extends ContentProvider {
    ...
    private static final String STR_FAILED_INTO = "Failed to insert row into ";
    ...
    static {
        ...
        uriMatcher.addURI(OmronDBConstans.AUTHORITY, OmronDBConstans.WHEEZE_DATA_TABLE, OmronDBConstans.WHEEZE_DATA);
        uriMatcher.addURI(OmronDBConstans.AUTHORITY, OmronDBConstans.PAIRING_DATA_TABLE, OmronDBConstans.PAIRING_DATA);
        uriMatcher.addURI(OmronDBConstans.AUTHORITY, OmronDBConstans.PERSONAL_DATA_TABLE, OmronDBConstans.PERSONAL_DATA);
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (choice) {
            ...
            case OmronDBConstans.WHEEZE_DATA:
            case OmronDBConstans.PAIRING_DATA:
            case OmronDBConstans.PERSONAL_DATA:
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case OmronDBConstans.VITAL_DATA:
                ...
                throw new SQLException(STR_FAILED_INTO + uri);
            ...
            case OmronDBConstans.WHEEZE_DATA:
                rowID = mSqldb.insert(OmronDBConstans.WHEEZE_DATA_TABLE, "",
                        values);
                if (rowID > 0) {
                    retUri = ContentUris.withAppendedId(OmronDBConstans.WHEEZE_DATA_CONTENT_URI, rowID);
                    getContext().getContentResolver().notifyChange(uri, null);
                    return retUri;
                }
                throw new SQLException(STR_FAILED_INTO + uri);
            ...
            case OmronDBConstans.PAIRING_DATA:
                rowID = mSqldb.insert(OmronDBConstans.PAIRING_DATA_TABLE, "",
                        values);
                if (rowID > 0) {
                    retUri = ContentUris.withAppendedId(OmronDBConstans.PAIRING_DATA_CONTENT_URI, rowID);
                    getContext().getContentResolver().notifyChange(uri, null);
                    return retUri;
                }
                throw new SQLException(STR_FAILED_INTO + uri);
            ...
            case OmronDBConstans.PERSONAL_DATA:
                rowID = mSqldb.insert(OmronDBConstans.PERSONAL_DATA_TABLE, "",
                        values);
                if (rowID > 0) {
                    retUri = ContentUris.withAppendedId(OmronDBConstans.PERSONAL_DATA_CONTENT_URI, rowID);
                    getContext().getContentResolver().notifyChange(uri, null);
                    return retUri;
                }
                throw new SQLException(STR_FAILED_INTO + uri);
    ...
    public static class DbHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            db.execSQL(OmronDBConstans.SQL_CREATE_WHEEZE_DATA_TABLE);
            db.execSQL(OmronDBConstans.SQL_CREATE_PAIRING_DATA_TABLE);
            db.execSQL(OmronDBConstans.SQL_CREATE_PERSONAL_DATA_TABLE);
        }
    }
}
